...
def pickConfigForFunction(functionIndex: int) -> Dict[str, float | str | int]:
    configMap: Dict[int, Dict[str, float | str | int]] = {
        1: {"acq": "ei", "kappa": 1.2, "xi": 0.0, "localFrac": 0.75, "localStd": 0.060, "topK": 3},
        2: {"acq": "ei", "kappa": 0.0, "xi": 1e-6, "localFrac": 1.00, "localStd": 0.005, "topK": 1},
        3: {"acq": "ei", "kappa": 0.0, "xi": 1e-6, "localFrac": 1.00, "localStd": 0.004, "topK": 1},
        4: {"acq": "ucb", "kappa": 0.8, "xi": 0.0, "localFrac": 0.70, "localStd": 0.045, "topK": 3},
        5: {"acq": "fixed", "kappa": 0.0, "xi": 0.0, "localFrac": 0.0, "localStd": 0.0, "topK": 1},
        6: {"acq": "ucb", "kappa": 1.2, "xi": 0.0, "localFrac": 0.65, "localStd": 0.070, "topK": 5},
        7: {"acq": "ei", "kappa": 0.0, "xi": 1e-6, "localFrac": 0.95, "localStd": 0.012, "topK": 1},
...
def suggestNextPoint(
    ...
    if functionIndex == 2:
        xFit, yFit = filterTopK(xTrain, yTrain, 15)
    elif functionIndex == 6:
        xFit, yFit = filterTopK(xTrain, yTrain, 12)
    else:
